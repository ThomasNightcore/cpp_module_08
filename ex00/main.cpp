...
int main(void)
{
	...
	std::cout << " ======== Testing with vector (size = " << vect_size << ") ======== " << std::endl;
	...
	std::cout << std::endl << " ======== Testing with deque (size = " << queue_size << ") ======== " << std::endl;
	...
	std::cout << std::endl << " ======== Testing with list (size = " << list_size << ") ======== " << std::endl;
