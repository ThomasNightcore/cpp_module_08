...
template <typename T, typename C>
typename MutantStack<T, C>::const_iterator
MutantStack<T, C>::begin(void) const {
    return this->c.begin();
}
...
template <typename T, typename C>
typename MutantStack<T, C>::const_reverse_iterator
MutantStack<T, C>::rbegin(void) const {
    return this->c.rbegin();
}
...
template <typename T, typename C>
typename MutantStack<T, C>::const_reverse_iterator
MutantStack<T, C>::rend(void) const {
    return this->c.rend();
}
